...
hist(total_steps_by_date, col="red", main = "Total Steps frecuency Histogram",xlab = "") 
```
```{r}
# getting the medians
...
```{r fig.width=7, fig.height=6}
# graph to find the histogram
hist(filledMeanInterval, col="blue", main = "Means Histogram recalculated",xlab = "Days")  
```
Next Graphics:
